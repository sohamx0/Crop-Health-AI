...
# ✨ --- IMPORT THE CORRECT PREPROCESSOR --- ✨
...
try:
    # This loads the 'plant_disease_model.h5' file you copied into the EDI folder
...
def get_ollama_fertilizer_recommendation(plant_name, disease_name, is_healthy, lat, lon):
    ...
    try:
        response = ollama.chat(
            model='llama3.1:8b', # Make sure Ollama is running this model
...
def predict_disease_route():
    ...
    try:
        # --- ✨ STEP 1: PREPROCESSING MUST MATCH THE NEW RESNET50 MODEL ---
        
        # 1. Resize to 224x224 (your old model used 128x128)
        ...
        # 4. Use the specific ResNet50 preprocessor
        # (Your old model just divided by 255.0)
        ...
        # --- Step 3: Get Fertilizer Recommendation from Ollama ---
...
if __name__ == '__main__':
    # Set debug=False when you want to share it with ngrok
